...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    let affairsArray = affairs;
    if (filter === 'all') {
        return affairsArray
    } else {
        affairsArray = affairsArray.filter(affairsObject => affairsObject.priority === filter)
    }
    return affairsArray;
}
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    let affairsArray = affairs;
    affairsArray = affairsArray.filter((affairsObject) => affairsObject._id != _id)
    return affairsArray;
}
